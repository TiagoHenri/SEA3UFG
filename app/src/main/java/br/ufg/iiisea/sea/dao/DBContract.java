...
public final class DBContract {
    ...
    public final class UsuarioEntry {
        ...
        public static final String SQL_CREATE_ENTRIES =
                "CREATE TABLE " + TABLE_NAME + "("
                        ...
                        + COLUMN_NAME_NOME + " NOT NULL TEXT,"
                        + COLUMN_NAME_EMAIL + " UNIQUE TEXT,"
                        + COLUMN_NAME_SENHA + " NOT NULL TEXT)";
    ...
    public final class NoticiaEntry {
        ...
        public static final String SQL_CREATE_ENTRIES =
                "CREATE TABLE " + TABLE_NAME + "("
                        ...
                        + COLUMN_NAME_TITULO + " NOT NULL TEXT,"
                        + COLUMN_NAME_CONTEUDO + " NOT NULL TEXT,"
    ...
    public final class PalestraEntry implements BaseColumns {
    ...
    public final class PalestranteEntry implements BaseColumns {
    ...
    public final class PalestraPalestranteEntry implements BaseColumns {
    ...
    public final class ProgramacaoEntry implements BaseColumns {
